...
pubDate: 2024-06-04
image: '/src/content/posts/images/initial.png'
...
All of our applications were built in <span class="link__color">[LitHTML](https://lit.dev/)</span> which uses the ShadowDOM method. Most styling needed to be encapsulated within the component &mdash; excepting where CSS Properties were called. 
...
<div class="video-player" style="width: 100%">
    <Vimeo id="https://vimeo.com/943059317?share=copy"  posterQuality="max" />
</div>
...
<div class="video-player" style="width: 100%">
    <Vimeo id="https://vimeo.com/943059920?share=copy" posterQuality="max" />
</div>
...
<div class="video-player" style="width: 100%">
    <Vimeo id="https://vimeo.com/943058024?share=copy" posterQuality="max" />
</div>
